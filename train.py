...
def generate_sunny(num_return_sequences=3, max_length=200):
    """Generate sample Always Sunny dialogue."""
    tokenizer = tiktoken.get_encoding('gpt2')
    prompts = [
        "INT. PADDY'S PUB - DAY\n\nDENNIS:",
        "INT. PADDY'S PUB - DAY\n\nCHARLIE: Guys, you're not gonna believe this -",
        "MAC: I've been doing some ocular pat-downs and",
        "DEE: Oh my god, you guys are not gonna believe what just happened",
        "FRANK: So anyway, I started"
    ]
...
print("\nTesting generation with the trained model:")
generate_sunny(3, 200)  # Generate 3 samples of 200 tokens each
